    ...
    categories: [
      {
        ...
        ordre: 0,
        produits: [
          { ref: "TCF 02", label: "Tasse Orange - Blanc", note2: "350 ml", moq: 3, step: 3, prixRevendeur: 10.23, prixPublic: 18, enLigne: true },
          { ref: "TCF 03", label: "Tasse Rose - Blanc", note2: "350 ml", moq: 3, step: 3, prixRevendeur: 10.23, prixPublic: 18, enLigne: true },
          { ref: "TCF 05", label: "Tasse Bleu - Blanc", note2: "350 ml", moq: 3, step: 3, prixRevendeur: 10.23, prixPublic: 18, enLigne: true },
          { ref: "TCF 06", label: "Tasse Noir - Blanc", note2: "350 ml", moq: 3, step: 3, prixRevendeur: 10.23, prixPublic: 18, enLigne: true },
          { ref: "TCF 10", label: "Tasse Blanc - Rouge", note2: "350 ml", moq: 3, step: 3, prixRevendeur: 10.23, prixPublic: 18, enLigne: true },
          { ref: "TCF 14", label: "Tasse Noir - Jaune", note2: "350 ml", moq: 3, step: 3, prixRevendeur: 10.23, prixPublic: 18, enLigne: true },
          { ref: "TCF 15", label: "Tasse Noir - Rouge", note2: "350 ml", moq: 3, step: 3, prixRevendeur: 10.23, prixPublic: 18, enLigne: true },
        ],
      },
      {
        nom: "Tasse Céramique",
        ...
        ordre: 1,
        produits: [
          { ref: "TC 03", label: "Tasse Rose - Blanc", note1: "Choix de designs en fonction du stock", note2: "350 ml", moq: 3, step: 3, prixRevendeur: 10.23, prixPublic: 18, enLigne: true },
          { ref: "TC 04", label: "Tasse Bleu - Blanc", note1: "Choix de designs en fonction du stock", note2: "350 ml", moq: 3, step: 3, prixRevendeur: 10.23, prixPublic: 18, enLigne: true },
          { ref: "TC 09", label: "Tasse Blanc - Orange", note1: "Choix de designs en fonction du stock", note2: "350 ml", moq: 3, step: 3, prixRevendeur: 10.23, prixPublic: 18, enLigne: true },
          { ref: "TC 10", label: "Tasse Blanc - Rouge", note1: "Choix de designs en fonction du stock", note2: "350 ml", moq: 3, step: 3, prixRevendeur: 10.23, prixPublic: 18, enLigne: true },
          { ref: "TC 15", label: "Tasse Noir - Rouge", note1: "Choix de designs en fonction du stock", note2: "350 ml", moq: 3, step: 3, prixRevendeur: 10.23, prixPublic: 18, enLigne: true },
          { ref: "TC 16", label: "Tasse Noir - Vert", note1: "Choix de designs en fonction du stock", note2: "350 ml", moq: 3, step: 3, prixRevendeur: 10.23, prixPublic: 18, enLigne: true },
        ],
      },
      {
        nom: "Tasse Métal",
