...
import { getCatalogFamiliesData, slugifyLabel } from "@/lib/catalog-source";
      ...
      <div className={styles.panel}>
        ...
        <nav className={styles.nav}>
          <div className={styles.navGroup}>
            <Link
              className={`${styles.familyLink} ${activeRoot ? styles.activeFamily : ""}`.trim()}
              href="/catalogue"
            >
